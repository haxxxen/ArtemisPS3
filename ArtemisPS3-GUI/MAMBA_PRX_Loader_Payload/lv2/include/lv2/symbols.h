...
#define shutdown_copy_params_call					0xAB4C
#define shutdown_patch_offset						0xAB38
#elif defined(FIRMWARE_4_75DEH) || defined(FIRMWARE_4_76DEH) || defined(FIRMWARE_4_78DEH) // Ported by Joonie, special thanks to @aldostools for his awesome Getsymbol tool!!!!
